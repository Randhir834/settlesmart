      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-100 mb-6">
            ...
            <span className="text-sm font-medium text-brand-700">Our Edge</span>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="glass-card rounded-3xl p-8 feature-card text-center">
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-brand-100 to-brand-50 flex items-center justify-center mx-auto mb-6">
          ...
          {/* Card 2 - Featured */}
          <div className="glass-card rounded-3xl p-8 feature-card text-center relative bg-gradient-to-br from-brand-500 to-brand-600 text-white">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2">
              <span className="px-4 py-1 rounded-full bg-brand-100 text-brand-900 text-sm font-bold">
                MOST LOVED
              </span>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-surface-900">Free Forever</p>
                    <p className="text-sm text-surface-600">Basic splitting, groups, UPI payments</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-brand-100 flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <p className="font-semibold text-surface-900">Premium (₹99/month)</p>
                    <p className="text-sm text-surface-600">Advanced analytics, unlimited groups, priority support</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex justify-center">
              <div className="glass-card rounded-2xl p-6 w-full max-w-sm">
                <div className="text-center mb-6">
                  <p className="text-surface-500 text-sm mb-1">Premium Plan</p>
                  <p className="text-4xl font-bold text-surface-900">₹99<span className="text-lg text-surface-500">/mo</span></p>
                </div>
                ...
                <button className="btn-primary w-full py-3 rounded-xl text-white font-semibold">
                  Upgrade to Premium
                </button>
              </div>
            </div>
